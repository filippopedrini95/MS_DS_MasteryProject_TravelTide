...
Note:
User-level EDA was not performed strictly before this step. Instead, the user EDA notebook was used iteratively throughout the project and is listed at the end of the workflow.
Output: user_RFM.csv
